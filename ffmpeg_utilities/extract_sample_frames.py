"""
This is the old one, which works by calling Shaowei's vid_extract bash script
and 
Maybe lets stop using this soon.
"""
import subprocess
...
for frame_index in range(first_frame_index, last_frame_index + 1, 1000):
