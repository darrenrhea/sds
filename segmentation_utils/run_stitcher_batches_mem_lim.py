...
assert which_gpu in [0, 1], "ERROR: which_gpu must be 0 or 1 to identify which of the two gpus selected by gpu_substring you want."
...
batch_of_tiles = np.zeros(
    shape=(num_tiles_per_batch, 3, nn_input_height, nn_input_width),
    dtype=np.float32
)
