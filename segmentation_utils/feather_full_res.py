...
# This program takes in num_frames_per_gpu_batch image files at a time,
...
i_stride = nn_input_height  # Because nn_input_height - 20 = 260.  TODO: generalize this.
...
total_score = np.zeros(shape=[num_frames_per_gpu_batch, height, width], dtype=np.int32)
num_times_scored_np = np.zeros([num_frames_per_gpu_batch, height, width], dtype=np.int32)
