...
class SegmentationDatasetNoRelevance(torch.utils.data.IterableDataset):
    """
    We got rid of the relevance thing for now while we try out ternausnet and feathered labels.
    """
    def __init__(
        self,
        nn_input_height,
