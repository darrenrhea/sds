...
def test_cutout_a_nonempty_patch_from_fullsize():
    ...
    print("fullsize:")
    prii(fullsize_image_np_u8[:, :, :3])
    prii(fullsize_image_np_u8[:, :, 3])
    prii(fullsize_image_np_u8[:, :, 4])

    patch = cutout_a_nonempty_patch_from_fullsize(
...
if __name__ == "__main__":
    test_cutout_a_nonempty_patch_from_fullsize()