from write_hw_np_f16_to_16_bit_grayscale_png import (
     write_hw_np_f16_to_16_bit_grayscale_png
)
import textwrap
import numpy as np
import PIL.Image
...
def test_write_hw_np_f16_to_16_bit_grayscale_png_1():
    ...
    hw_np_f16 = (x+y + 1).astype(np.float16)
...
if __name__ == "__main__":
    test_write_hw_np_f16_to_16_bit_grayscale_png_1()