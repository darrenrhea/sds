...
def test_ffst_flatten_for_segmentation_training_1():
    ...
    for approved_annotation in approved_annotations:        
        ...
        visibility_mask_file_path = out_dir / f"{clip_id}_{frame_index:06d}_relevance.png"
        ...
        prii(visibility_mask, out=visibility_mask_file_path)
...
if __name__ == "__main__":
    test_ffst_flatten_for_segmentation_training_1()
    print("ffst_flatten_for_segmentation_training passed")