...
def get_original_path(
    ...
    """
    Given a clip_id, frame_index, returns the local path to the desired original video frame.
    """
    ...
    folder_containing_the_frames = shared_dir / "clips" / clip_id / "frames"
    original_path = folder_containing_the_frames / f"{clip_id}_{frame_index:06d}_original.png"
    if original_path.exists():
        return original_path
    else:
        original_path2 = folder_containing_the_frames / f"{clip_id}_{frame_index:06d}_original.jpg"
