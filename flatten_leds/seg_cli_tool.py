from infer_clip_id_frame_index import (
     infer_clip_id_frame_index
)
...
def seg_cli_tool():
    """
    Just segment the frame indices for a clip_id and final_model_id
    """
        ...
        try:  
            ...
            raise ValueError(
                textwrap.dedent(
                    ...
                    seg -m pasted4 -c hou-was-2024-11-11-sdi 102798
                    """
                )
            )
    if clip_id is None:
        ...
        try:
            ...
            raise ValueError(
                textwrap.dedent(
                    ...
                    seg -m slflatpatch30 -c slgame9day1 1000
                    """
                )
            )
    ...
    for frame_index in frame_indices:
        ...
        composition_rgba_hwc_np_u8 = infer_clip_id_frame_index(
