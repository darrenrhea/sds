...
def fasternet_s(**kwargs):
    # '../model_ckpt/fasternet_s-epoch=299-val_acc1=81.2840.pth'
    model = FasterNet(
        mlp_ratio=2.0,
        embed_dim=128,
        depths=(1, 2, 13, 2),
...
def fasternet_m(**kwargs):
    # '../model_ckpt/fasternet_m-epoch=291-val_acc1=82.9620.pth',
    model = FasterNet(
        mlp_ratio=2.0,
        embed_dim=144,
        depths=(3, 4, 18, 3),
...
def fasternet_l(**kwargs):
    # '../model_ckpt/fasternet_l-epoch=299-val_acc1=83.5060.pth',
    model = FasterNet(
        mlp_ratio=2.0,
        embed_dim=192,
        depths=(3, 4, 18, 3),
